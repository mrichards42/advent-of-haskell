...
module Advent.Y2019.Day05 (part1, part2) where

import Advent.Y2019.IntCode as IC
...
-- | >>> readFile "input/2019/day05.txt" >>= return . part1
-- 10987514
part1 :: String -> Int
part1 = runTest 1
...
-- | >>> readFile "input/2019/day05.txt" >>= return . part2
-- 14195011
part2 :: String -> Int
part2 = runTest 5
