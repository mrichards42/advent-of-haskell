...
module Advent.Y2019.Day01 (part1, part2) where
...
parseInput inputStr = map read (lines inputStr)
...
-- | >>> readFile "input/2019/day01.txt" >>= return . part1
-- 3421505
part1 :: String -> Integer
part1 = sum . map fuelRequirement . parseInput
...
-- |
-- >>> totalFuelRequirement 14
-- 2
-- >>> totalFuelRequirement 1969
-- 966
-- >>> totalFuelRequirement 100756
-- 50346
totalFuelRequirement :: Integer -> Integer
totalFuelRequirement mass =
  sum $ takeWhile (> 0) (allRequirements mass)
    where allRequirements = drop 1 . iterate fuelRequirement

-- | >>> readFile "input/2019/day01.txt" >>= return . part2
-- 5129386
part2 :: String -> Integer
part2 = sum . map totalFuelRequirement . parseInput
