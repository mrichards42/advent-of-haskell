{- 1202 Program Alarm -}
module Advent.Y2019.Day02 (part1, part2) where
...
-- | >>> readFile "input/2019/day02.txt" >>= return . part1
-- 6568671
part1 :: String -> Int
part1 =
    flip IC.valAt 0
  . IC.runProgram
  . flip IC.setInput (12, 2)
  . IC.fromString
...
solvePart2 :: Int -> IC.Computer -> Int
solvePart2 target c = 
  head [100 * noun + verb | noun <- [0..99]
                          , verb <- [0..99] 
                          , run (noun, verb) == target ]
  where
    run :: (Int, Int) -> Int
    run = flip IC.valAt 0 . IC.runProgram . IC.setInput c

-- | >>> readFile "input/2019/day02.txt" >>= return . part2
-- 3951
part2 :: String -> Int
part2 = solvePart2 19690720 . IC.fromString
